...
class trunkCar: car{
    ...
    init(ObemDvig: Double, massa: Double, Cvet: String, Marka: String, StatusWindows: String, StatusDvig: Double, CusovStatus : kuzov, MGruza: Mgruza, action: actionKuzov){
        self.ObemDvig = ObemDvig
        self.massa = massa
        self.Cvet = Cvet
        self.Marka = Marka
...
var car2 = trunkCar(ObemDvig: 4, massa: 40000, Cvet: "Blue", Marka: "Audi", StatusWindows: "down", StatusDvig: 1, CusovStatus: .pustKuz(empty: "Пустой"), MGruza: .Kuz(tonn: 20), action: .upload)
